// missionVisionData.js

export const missionVisionData = {
  vision: {
    icon: "fa-solid fa-user-doctor",
    title: "Vision",
    text: `To be a pioneering centre of healing, nursing and clinical
           learning that delivers world-class, affordable healthcare to
           one and all in Maharashtra and beyond with a special
           commitment to tribal and rural communities, while nurturing
